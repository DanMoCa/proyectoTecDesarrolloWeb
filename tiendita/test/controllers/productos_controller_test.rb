...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { Descripcion: @producto.Descripcion, Nombre: @producto.Nombre, Precio: @producto.Precio }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { Descripcion: @producto.Descripcion, Nombre: @producto.Nombre, Precio: @producto.Precio }
    assert_redirected_to producto_path(assigns(:producto))
  end
